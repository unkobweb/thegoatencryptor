...
Route.get('/docker/killAllOld','DockersController.killAllOld')
Route.put('/getInviteCode','AuthController.getInviteCode')
Route.get('/getInviteCode','AuthController.oldGetInviteCode')